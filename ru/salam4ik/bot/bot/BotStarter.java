                    ...
                    try {
                        ...
                        if (BotCommand.aura) {
                            ...
                            if (e != null && e != bot.getBot()) {
                                ...
                                bot.getBot().rotationYaw = BotStarter.normalizeYaw(vector2f.y) + UwU_.GameSense.helpers.math.MathHelper.getRandomNumberBetween(-3, 3);
                                bot.getBot().rotationPitch = BotStarter.normalizePitch(vector2f.x) + UwU_.GameSense.helpers.math.MathHelper.getRandomNumberBetween(-1, 1);
                        ...
                        if (BotCommand.movingRandom) {
                            bot.getBot().rotationYaw += UwU_.GameSense.helpers.math.MathHelper.getRandomNumberBetween(-20, 20);
                            bot.getConnection().forward = true;
                        }
