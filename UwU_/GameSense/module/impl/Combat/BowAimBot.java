...
public class BowAimBot extends Module {
    ...
    public void rotate(EventMotion e) {
        resolveX = UwU_.GameSense.helpers.math.MathHelper.interpolate((target.posX - target.prevPosX) * 3, resolveX, 0.1);
        resolveZ = UwU_.GameSense.helpers.math.MathHelper.interpolate((target.posZ - target.prevPosZ) * 3, resolveZ, 0.1);
