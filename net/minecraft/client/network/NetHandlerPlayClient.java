    ...
    public void handleBlockChange(SPacketBlockChange packetIn)
    {
        ...
        try {
            if (this.world.getBlockState(packetIn.getBlockPosition()).getBlock() == Blocks.AIR
                ...
                if (baritone.getMineProcess().isActive() && baritone.getMineProcess() instanceof MineProcess && (Main.m.getModule(UwU_.GameSense.module.impl.Player.Baritone.class).state && ((UwU_.GameSense.module.impl.Player.Baritone) Main.m.getModule(Baritone.class)).antirg.get())) {
