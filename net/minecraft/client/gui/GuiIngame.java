...
import UwU_.GameSense.event.EventManager;
...
import UwU_.GameSense.module.impl.Player.Timer;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        animatedYText = UwU_.GameSense.helpers.math.MathHelper.interpolate(scrollPos, animatedYText, 0.05);
        ...
        Main.notify.render();
        {
            ...
            if (t.smart.get()) {
                t.animWidth = (float) UwU_.GameSense.helpers.math.MathHelper.interpolate((100 - (t.ticks * 4)), t.animWidth, 0.05f);
        ...
        a = UwU_.GameSense.helpers.math.MathHelper.interpolate((mc.gameSettings.keyBindPlayerList.isKeyDown() ? 1 : 0), a, 0.1);
